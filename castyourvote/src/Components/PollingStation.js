...
const PollingStation = (props) => {
  ...
  const [candidate2URL, changeCandidate2Url] = useState("data:image/png;base64,");
    ...
    <Container>
      <Row>
        <Col className='jutify-content-center d-flex'>
          <Container>
            <Row style={{ marginTop: "5vh", backgroundColor: "#F5B041" }}>
              <div
                style={{
                  display: "flex", justifyContent: "center", padding: "3vw",
                }}>
                <img
            ...
            <Row
              style={{ marginTop: "5vh" }}
              className='justify-content-center d-flex'>
              <Button disabled={buttonStatus} onClick={() => addVote(0)}>Vote</Button>
            </Row>
          </Container>
        </Col>
        ...
        <Col className='jutify-content-center d-flex'>
          <Container>
            ...
            <Row
              style={{ marginTop: "5vh" }}
              className='justify-content-center d-flex'>
              <Button disabled={buttonStatus} onClick={() => addVote(1)}>Vote</Button>
            </Row>
          </Container>
        </Col>
      </Row>
